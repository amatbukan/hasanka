...
?>
                            <tr>
                              ...
                              <td width="350"><?=$r->nama_content;?></td>
                              <td align="center"><?=$r->code;?></td>
                              <td align="center"><?=$r->posisi;?></td>
                              <td align="center"><?=$r->aktif;?></td>
							  <td align="center" width="100">
								<a href="fcontent?id=<?=$r->id_content;?>&aksi=e" class="btn btn-sm btn-warning" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Ubah Content"><span class="fa fa-edit"></span></a></span></a>
							</td>
                            </tr>
<?php
$no++;
