...
?>
					...
					<a href="fpengguna?aksi=t" class="btn btn-primary btn-sm"><span class="fa fa-plus"></span> Tambah</a>
					</span>
...
?>
                            <tr>
                              ...
                              <td width="200" align="center"><?=$r->nama_lengkap;?></td>
                              <td align="center"><?=$r->email;?></td>
                              <td align="center"><img src='../foto_user/small_<?php echo $r->foto;?>' width=50></td>
