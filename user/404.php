...
-------------------------------------------------------*/  
    ...
    <body>
    <div class="container" style="max-width:400px; margin:10% auto;">
      
        <div class="four-oh-four"><h1>404 Error</h1></div>
              
        <div class="warning">            
            <h2>"Pemberitahuan"</h2>
            <p>Anda harus login untuk mengakses halaman ini, atau halaman yang Anda cari tidak ada</p>
            <a href="index">Kembali Ke Login</a>
        </div>

        <div class="footer"><p class="copyright">&copy; 2018 Muhammad Maulani</p></div>        
